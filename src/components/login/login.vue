<template>
  <div class="main">
    <!-- <div class="toper"> -->
    <!-- <NavHeader activeTab="6" :dontCallUsession="true"></NavHeader> -->
    <!-- </div> -->
    <div class="contenter">
        ...
        <div class="pointer">
          <div class="login-win">
            <el-form ref="AccountFrom" :model="account" :rules="rules" label-position="left" label-width="0px" class="demo-ruleForm login-container">
              ...
              <el-form-item prop="u_fix">
                <el-select v-model="phonefix.value" placeholder="请选择" style="width: 100%">
                  <el-option v-for="(item) in phonefix.options" :label="item.name" :value="item.code" :key="item.value">
                  </el-option>
                </el-select>
              </el-form-item>
              ...
              <el-row :gutter="20">
                <el-col :span="12">
                  <div class="grid-content bg-purple">
                    <el-form-item prod="u_code">
                      <el-input type="text" v-model="account.u_code" auto-complete="off" placeholder="请输入验证码"></el-input>
                    </el-form-item>
                  </div>
                </el-col>
                <el-col :span="10">
                  <div class="grid-content bg-purple">
                    <el-form-item style="width:100%;">
                      <img :src="validateImg" @click="getValidateImg" alt="" class="validate-code">
                    </el-form-item>
                  </div>
                </el-col>
              </el-row>
...
export default {
  data() {
    return {
      ...
      rules: {
        ...
        u_code: [{ required: true, message: "请输入验证码", trigger: "blur" }]
      }
    };
  },
  mounted() {
    //初始化
    console.log("init:", loginRegist);
  },
  // components: {
  //   NavHeader,
  //   mFooter
  // },
  created() {
    this.$root.eventHub.$on("usessionFinish", this.usessionFinishFunc);
  },
  methods: {
          ...
          loginRegist
            ...
            .then(res => {
              ...
              if (res.statusCode != OK) {
                ...
                console.log("从store中获取数据if", this.$store.state.isLogin);
...
.main {
  height: 99.8vh;
  background: #30313c url('../../assets/login-bg.png') center center / 100% 100% no-repeat;
  display: flex;
